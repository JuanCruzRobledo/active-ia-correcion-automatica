# Spec: Entidad Universidad (Tenant de Primer Nivel)

## Purpose

Introducir la entidad `Universidad` como tenant de primer nivel en el modelo de datos. Cada universidad es una instancia independiente del sistema con su propia configuración de Moodle.
