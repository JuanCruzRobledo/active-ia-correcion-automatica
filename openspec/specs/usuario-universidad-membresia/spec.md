# Spec: Membresía Usuario-Universidad con Rol Scopeado

## Purpose

Introducir la tabla de junction `usuario_universidad` para modelar la membresía de un usuario en una universidad con un rol específico a esa universidad. Permite usuarios con diferentes roles en diferentes universidades. También introduce el flag `es_superadmin` en Usuario para marcar admins globales.
