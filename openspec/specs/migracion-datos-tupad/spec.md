# Spec: Migración de Datos para Universidad TUPaD

## Purpose

Definir el seed de la universidad TUPaD y el backfill de datos existentes para migrar a la estructura multi-tenant. Incluye creación de membresías y endurecimiento de constraints post-backfill.
