# Spec: Denormalización de universidad_id en Árbol de Materia

## Purpose

Agregar columna `universidad_id` denormalizada a todas las tablas que cuelgan del árbol de `Materia`. Esto permite consultas y filtrado eficiente por universidad sin necesidad de JOINs profundos. Incluye cambio de única composición en `materias.codigo` de global a scopeado por universidad.
