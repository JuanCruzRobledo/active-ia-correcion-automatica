# Capability: Permisos con Universidad Activa

## Purpose

Autorizar endpoints mediante el rol del usuario en la universidad activa del request, en lugar del rol global; permitir bypass total para superadmins; y mantener invariancia de seguridad en el estado mono-universidad actual.
