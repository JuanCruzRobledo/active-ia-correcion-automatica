...
- [ ] **2.6** Crear `backend/app/services/usuario_service.py`
...
- [ ] **2.7** Crear `backend/app/routers/usuarios.py`
...
- [ ] **2.12** Crear `backend/app/schemas/comision.py`
  **Archivos**: `backend/app/schemas/comision.py`

- [ ] **2.13** Crear `backend/app/repositories/comision_repository.py`
  **Archivos**: `backend/app/repositories/comision_repository.py`

- [ ] **2.14** Crear `backend/app/services/comision_service.py`
  **Incluir**: crear_comision, listar_comisiones, asignar_tutores
  **Archivos**: `backend/app/services/comision_service.py`

- [ ] **2.15** Crear `backend/app/routers/comisiones.py`
  **Endpoints**: GET, POST, GET/:id, PUT/:id, DELETE/:id, POST/:id/tutores
...
- [ ] **3.1** Crear `backend/app/schemas/rubrica.py`
...
- [ ] **3.8** Crear `backend/app/services/entrega_service.py`
...
- [ ] **3.9** Crear `backend/app/routers/entregas.py`
...
- [ ] **3.10** Crear `backend/app/repositories/entrega_historial_repository.py`
  **Archivos**: `backend/app/repositories/entrega_historial_repository.py`

- [ ] **3.11** Crear `backend/app/services/historial_service.py`
  **Incluir**: guardar_version_anterior
  **Archivos**: `backend/app/services/historial_service.py`

### Tests Fase 3

- [ ] **3.12** Tests para rubrica_service
  **Archivos**: `backend/tests/test_rubrica_service.py`

- [ ] **3.13** Tests para consolidacion_service
  **Archivos**: `backend/tests/test_consolidacion_service.py`

- [ ] **3.14** Tests para entrega_service
  **Archivos**: `backend/tests/test_entrega_service.py`
...
- [ ] **4.1** Crear `backend/app/integrations/n8n_client.py`
...
- [ ] **4.2** Crear `backend/app/schemas/correccion.py`
...
- [ ] **4.3** Crear `backend/app/repositories/correccion_repository.py`
  **Archivos**: `backend/app/repositories/correccion_repository.py`

- [ ] **4.4** Crear `backend/app/services/correccion_service.py`
...
- [ ] **4.5** Crear `backend/app/routers/correcciones.py`
